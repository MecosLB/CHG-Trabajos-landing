        ...
        <div className='details hidden md:block shadow-lg pb-4'>
            <article className="header flex items-center justify-between gap-4 shadow-md">
                <div className='wrapper flex flex-col justify-around'>
                    ...
                    <button onClick={() => { openController(job) }} job={job.id} className='btn text-sm lg:text-base text-white ease-in-out duration-100 bg-blue-950 focus:bg-blue-900 hover:bg-blue-900 mb-auto'>
                        Postularse
                    </button>
